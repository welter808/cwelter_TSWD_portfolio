...
This sketch also stayed true to it's Part II iteration, as feedback was pretty positive on this visualization from the beginning. It got a bit of a facelift in [Tableau](https://www.tableau.com/), and the addition of a secondary color. I wanted to call into attention how similar the pre-professional training committment is for  dancers and NFL players, and the dissimilarities of their corresponding salaries. The visual balancing effect of this population pyramid variation really helped to illustrate the assymetry of input and output for dancers. <br>
